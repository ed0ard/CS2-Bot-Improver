...
### Наблюдатели (режиссёрская позиция)

Добавьте ботов-наблюдателей: они переходят в команду наблюдателей и отображаются на табло. Имена берутся из того же общего пула, что и у обычных ботов (наблюдатели/комментаторы с [Liquipedia](https://liquipedia.net/counterstrike/Category:Casters) и про-игроки).

| Команда | Описание |
| --- | --- |
| `bot_spec [имя]` | Добавить бота-наблюдателя; без имени имя выбирается из общего пула |
| `bot_specs` | Список всех ботов-наблюдателей |
| `bot_kick <имя>` | Удалить бота-наблюдателя по имени (имена с пробелами — в кавычках) |
